...
**[Budget App]** is a mobile web application where you can manage your budget. There is a list of transactions associated with the category, so that you can see how much money you spent and on what.
...
- **[User]**
- **[Transactions associated with a group]**
...
Clone this repository to your desired folder:
  ...
  git clone git@github.com:Bhekisile/budget-app.git
...
- [ ] **[Add total amount spent on all categories]**
